...
| デモ | 用途 | スペック | リリース |
|---|---|---|---|
| D1 Usage | インストール、パイプライン実行、Studio 確認までのチュートリアル動画 | `demos/d1-usage/scene_specs.json` | [d1-usage.mp4](https://github.com/kimsh-1/reelforge/releases/download/v0.1.0/reelforge-d1-usage.mp4) |
| D2 Engine | HTML コンパイル、seek 決定論、ゲート構造を短く説明するエンジン紹介 | `demos/d2-engine/scene_specs.json` | [d2-engine.mp4](https://github.com/kimsh-1/reelforge/releases/download/v0.1.0/reelforge-d2-engine.mp4) |
| D3 Intro | ReelForge を初めて見る人向けのブランド/製品イントロ | `demos/d3-intro/scene_specs.json` | [d3-intro.mp4](https://github.com/kimsh-1/reelforge/releases/download/v0.1.0/reelforge-d3-intro.mp4) |
